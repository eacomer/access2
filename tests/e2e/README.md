...
- Optional patient-detail mutation tests verify task completion, task creation, escalation start refresh behavior, worklist refresh after detail-page task creation, and escalation resolution across detail/worklist.
