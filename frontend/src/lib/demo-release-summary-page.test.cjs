...
test("demo release summary page renders the protected V1 release posture", () => {
  ...
  [
    ...
    "V1 intentionally does not expose reviewer rejection mutation controls on this demo page.",
    "V1 intentionally skips the UI mutation test for override approval.",
    "8",
    "2",
    "0",
